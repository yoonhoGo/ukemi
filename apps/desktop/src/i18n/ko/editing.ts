...
export const editing: Record<string, string> = {
  ...
  "Checked hunks stay in the first change. Everything else moves to a new change on top. Nothing is staged; both are real commits when you finish.":
    "체크한 헝크는 첫 체인지에 남는다. 나머지는 위의 새 체인지로 옮겨간다. 스테이징은 없다. 끝내고 나면 둘 다 진짜 커밋이다.",
  "Checked hunks move into the parent commit. Everything else stays where it is. The parent keeps its own description.":
    "체크한 헝크는 부모 커밋으로 들어간다. 나머지는 그 자리에 남는다. 부모는 자기 설명을 그대로 쓴다.",
  "First change": "첫 체인지",
  ...
  "This revision changes nothing.": "이 리비전은 아무것도 바꾸지 않는다.",
  "Select a hunk.": "헝크를 고른다.",
  "Cannot edit by hunk — {problem}": "헝크 단위로 편집할 수 없다 — {problem}",
  "Runs {command} · undo with": "{command} 실행 · 되돌리기는",
  Cancel: "취소",
  "Check at least one hunk": "헝크를 최소 하나는 체크해야 한다",
  "Leave at least one hunk behind": "헝크를 최소 하나는 남겨야 한다",
  "Working…": "처리 중…",
  "1 hunk": "헝크 1개",
  ...
  "Binary file — it can only be taken or left whole.":
    "바이너리 파일 — 통째로 가져가거나 통째로 남기거나 둘 중 하나다.",

  // Inspector — 인스펙터
  "Describe this change…": "이 체인지 설명…",
  "Saving…": "저장 중…",
  Unsaved: "저장 안 됨",
  "Select a revision.": "리비전을 고른다.",
  "The window is parked on a past operation. Return to now to make changes.":
    "창이 지난 오퍼레이션에 멈춰 있다. 바꾸려면 현재로 돌아와야 한다.",
  "This revision is immutable.": "이 리비전은 바꿀 수 없다.",
  "@ working copy": "@ 작업 사본",
  conflict: "충돌",
  ...
  "Nothing is blocked. Resolve now or later — descendants pick it up automatically.":
    "막힌 건 없다. 지금 풀어도 되고 나중에 풀어도 된다 — 자손은 알아서 따라온다.",
  "Reading conflicts…": "충돌 읽는 중…",
  "Keep the first side (jj's :ours)": "첫 번째 쪽을 남긴다 (jj의 :ours)",
  "Take ours": "ours 선택",
  "Keep the second side (jj's :theirs)": "두 번째 쪽을 남긴다 (jj의 :theirs)",
  "Take theirs": "theirs 선택",
  "Edit the conflict markers by hunk instead": "대신 충돌 표시를 헝크 단위로 편집한다",
