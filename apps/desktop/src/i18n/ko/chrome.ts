...
export const chrome: Record<string, string> = {
  ...
  "Time travel": "시간 이동",
  "Move the working copy to the parent or the child": "워킹 카피를 부모나 자식으로 옮기기",
  "Move the working copy to the child": "워킹 카피를 자식으로 옮기기",
  "Move the working copy to the parent": "워킹 카피를 부모로 옮기기",
